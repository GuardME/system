<div class="p-6">
   <div class="flex items-center justify-end px-4 py-3  text-right sm:px6">
                        ...
                        @if ($data->count())
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">{!! \Illuminate\Support\Str::limit($item->content, 30, '...') !!}</td>
